...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecFormatErrorDetector) DeepCopyInto(out *ExecFormatErrorDetector) {
	*out = *in
	out.BasePlugin = in.BasePlugin
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecFormatErrorDetector.
func (in *ExecFormatErrorDetector) DeepCopy() *ExecFormatErrorDetector {
	if in == nil {
		return nil
	}
	out := new(ExecFormatErrorDetector)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Plugins) DeepCopyInto(out *Plugins) {
	*out = *in
	...
	if in.ExecFormatErrorDetector != nil {
		in, out := &in.ExecFormatErrorDetector, &out.ExecFormatErrorDetector
		*out = new(ExecFormatErrorDetector)
		**out = **in
	}
}
