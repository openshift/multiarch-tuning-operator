...
| --- | --- | --- | --- | --- |
| Manager | Static YAML in this directory (Kustomize/OLM) | `control-plane: controller-manager` | TCP 8081 (open), TCP 8443 from `openshift-monitoring` | TCP/UDP 5353 to `openshift-dns`, destination-less TCP 6443 |
...
- **9443**: destination-less webhook ingress for the same HCP/host-network reason as 6443.
