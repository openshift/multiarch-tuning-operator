	...
	return func(obj interface{}) {
		...
		if err != nil {
			s.log.Error(err, "Error updating ClusterPodPlacementConfig",
				"CPPC name", CPPC.Name, "webhook name", mutatingWebhookConfig.Name)
		} else {
			s.log.Info("Added ClusterPodPlacementConfig", "CPPC name", CPPC.Name, "namespace", CPPC.Namespace, "webhook name", mutatingWebhookConfig.Name)
		}
	}
}
