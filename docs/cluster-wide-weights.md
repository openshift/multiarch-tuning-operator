...
The resulting set of preferred affinity terms should be the union of the Cartesian product of the pod terms with the CPPC terms and the CPPC terms themselves:
